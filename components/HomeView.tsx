...
const MOCK_MOVIES: Movie[] = [
  { id: '1', title: 'Achromatic', category: 'Sci-Fi', imageUrl: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=800&auto=format&fit=crop', year: 2024, rating: '9.2', trending: true, description: 'A journey into the silent depth of space where time and color do not exist.' },
  { id: '2', title: 'The Gaze', category: 'Drama', imageUrl: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=800&auto=format&fit=crop', year: 2023, rating: '8.8', trending: true },
  { id: '3', title: 'Midnight City', category: 'Thriller', imageUrl: 'https://images.unsplash.com/photo-1509248961158-e54f6934749c?q=80&w=800&auto=format&fit=crop', year: 2024, rating: '9.0', trending: true },
  { id: '4', title: 'Echo Chamber', category: 'Fantasy', imageUrl: 'https://images.unsplash.com/photo-1533928298208-27ff66555d8d?q=80&w=800&auto=format&fit=crop', year: 2022, rating: '8.5' },
  { id: '5', title: 'The Concrete', category: 'Documentary', imageUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=800&auto=format&fit=crop', year: 2024, rating: '9.5' },
  { id: '6', title: 'Pulse', category: 'Sci-Fi', imageUrl: 'https://images.unsplash.com/photo-1614728263952-84ea206f99b6?q=80&w=800&auto=format&fit=crop', year: 2024, rating: '8.9' },
  { id: '7', title: 'Stasis', category: 'Sci-Fi', imageUrl: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?q=80&w=800&auto=format&fit=crop', year: 2023, rating: '8.2' },
];
...
const HomeView: React.FC<HomeViewProps> = ({ onToggleFavorite, favorites, onPlayMovie }) => {
  return (
    <div className="pb-12">
      {/* Shortened Cinematic Hero */}
      <section className="relative h-[45vh] w-full overflow-hidden mb-8">
        ...
        <div className="absolute bottom-0 left-0 p-6 md:p-12 max-w-2xl z-10">
          <div className="flex items-center space-x-3 mb-4">
            <span className="px-2 py-0.5 border border-white/40 text-white text-[8px] font-black rounded uppercase tracking-widest">Premiere</span>
            <span className="text-[8px] font-bold uppercase tracking-widest text-zinc-500">9.8 MetaScore</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tighter leading-none uppercase">Monolith</h1>
          <p className="text-zinc-500 text-xs md:text-sm mb-6 leading-relaxed font-medium line-clamp-2 max-w-md italic">
            "A visual symphony of solitude and cinematic purity."
          </p>
          <div className="flex items-center gap-3">
            <button 
                onClick={() => onPlayMovie(MOCK_MOVIES[0])}
      ...
      <div className="relative z-20 space-y-2">
        <MovieRow 
          title="Trending" 
          movies={MOCK_MOVIES.filter(m => m.trending)} 
        ...
        <MovieRow 
          ...
          movies={MOCK_MOVIES.filter(m => m.category === 'Sci-Fi' || m.category === 'Fantasy')} 
          onToggleFavorite={onToggleFavorite}
          favorites={favorites}
          onPlayMovie={onPlayMovie}
        />
