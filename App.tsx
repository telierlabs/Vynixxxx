...
const MOCK_MOVIES: Movie[] = [
  { id: '1', title: 'Achromatic', category: 'Sci-Fi', imageUrl: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=800&auto=format&fit=crop', year: 2024, rating: '9.2', trending: true },
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (currentPage === 'player' && activeMovie) {
        return (
          <PlayerView 
            ...
            relatedMovies={MOCK_MOVIES.filter(m => m.id !== activeMovie.id)}
    ...
    switch (currentPage) {
      case 'home':
        return <HomeView onNavigate={setCurrentPage} onToggleFavorite={toggleFavorite} onPlayMovie={playMovie} favorites={favorites} />;
      case 'news':
        return <NewsView />;
      case 'ai-assistant':
